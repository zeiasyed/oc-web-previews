      ...
      <div className="min-h-screen bg-charcoal pb-10">
        <div className="px-5 pt-12">
          <button
            ...
            className="text-gold hover:text-gold text-sm mb-4 transition-colors flex items-center gap-1"
          >
            <ArrowLeft size={16} />
            Back to centers
          </button>
      ...
      <div className="px-5 pt-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-white text-sm">Manage center info, programs & announcements</p>
          </div>
          <button
          ...
          {mosques.map((mosque) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-white text-xs">{mosque.city}, {mosque.state}</p>
              </div>
            </button>
          ))}
        </div>
          ...
          announcements.map((a) => (
            <div key={a.id} className="bg-white/5 rounded-xl p-4 border border-white/5 flex items-start justify-between">
              <div>
                ...
                <p className="text-white text-xs mt-1">{a.content}</p>
                <p className="text-gold text-xs mt-1 capitalize">{a.type} · {a.date}</p>
              </div>
              <button
