  ...
  return (
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <p className="text-white/70 text-sm mb-8">Customize your reading experience</p>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/10 mb-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-white/70 text-xs">Adjust text size for easier reading</p>
            </div>
          </div>
            ...
            {FONT_OPTIONS.map((option) => (
              ...
              >
                ...
                <span className={`text-xs ${
                  fontSize === option.value ? 'text-gold font-medium' : 'text-white/70'
                }`}>
                  {option.label}
                </span>
              </button>
