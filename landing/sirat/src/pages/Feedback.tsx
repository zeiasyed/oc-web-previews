    ...
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/10 mb-6">
          <div className="mb-4">
            <label className="text-white/80 text-xs font-medium block mb-2">Category</label>
          ...
          <div className="mb-4">
            <label className="text-white/80 text-xs font-medium block mb-2">Your Suggestion</label>
            <textarea
              value={message}
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white text-sm
                         placeholder:text-white/40 focus:outline-none focus:border-gold/50 resize-none"
              rows={4}
            />
          </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-white/50 text-xs mt-2">— {item.author}</p>
                    </div>
                    <button
                    ...
                    >
                      <ThumbsUp size={14} className="text-white/70" />
                      <span className="text-white/70 text-xs font-medium">{item.votes}</span>
                    </button>
                  </div>
                </div>
              ))}
        ...
        {feedbackList.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-white/50 text-sm">No feedback yet. Be the first to suggest something!</p>
          </div>
        )}
      </div>
