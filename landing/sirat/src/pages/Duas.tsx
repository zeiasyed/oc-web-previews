      ...
      <div className="min-h-screen bg-charcoal pb-20">
        <div className="px-5 pt-12">
          <button
            ...
            className="text-gold hover:text-gold/80 text-sm mb-6 transition-colors flex items-center gap-1"
          >
            <ArrowLeft size={14} />
            Back to Duas
          </button>
          ...
          <p className="text-white/70 text-xs mb-8">{selectedDua.occasion}</p>
          ...
          {duasData.map((dua) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white/70 text-xs mt-0.5">{dua.occasion}</p>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                <span className="text-white/60 text-xs font-arabic" dir="rtl">{dua.arabicName}</span>
                <ChevronRight size={16} className="text-white/50 group-hover:text-gold transition-colors" />
              </div>
            </button>
          ))}
        </div>
