  ...
  return (
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <p className="text-white/78 text-sm mb-6">News from across the community</p>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-12">
            <Megaphone size={40} className="text-white/45 mx-auto mb-4" />
            <p className="text-white/68 text-sm">No announcements</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-white/55 text-xs">{announcement.date}</span>
                  </div>
                  <h3 className="text-white font-medium text-sm">{announcement.title}</h3>
                  <p className="text-white/78 text-xs mt-2 leading-relaxed">{announcement.content}</p>
                  <p className="text-gold/78 text-xs mt-2">— {getMosqueName(announcement.mosqueId)}</p>
                </div>
              );
            })}
          </div>
