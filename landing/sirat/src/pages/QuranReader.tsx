  ...
  return (
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <p className="text-white/78 text-sm mb-6">Quick reference to surahs</p>
        ...
        <input
          ...
          className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white 
                     placeholder-white/55 focus:outline-none focus:border-gold/50 text-sm mb-6"
        />
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white/93 text-base font-arabic" dir="rtl">
                    {surah.arabic}
                  </span>
                </div>
              ...
              <ExternalLink size={14} className="text-white/45 group-hover:text-gold/78 transition-colors flex-shrink-0" />
            </button>
          ))}
        </div>
        ...
        <div className="mt-6 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 text-gold/93 hover:text-gold text-sm transition-colors"
          >
            <Book size={16} />
