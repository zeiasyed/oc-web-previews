  ...
  return (
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <p className="text-white/95 text-sm mb-8">Face the direction of the Kaaba</p>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="relative w-64 h-64 rounded-full bg-white/5 border-2 border-white/10 flex items-center justify-center">
            ...
            <div className="absolute top-2 left-1/2 -translate-x-1/2 text-white/92 text-xs">N</div>
            <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-white/92 text-xs">S</div>
            <div className="absolute left-2 top-1/2 -translate-y-1/2 text-white/92 text-xs">W</div>
            <div className="absolute right-2 top-1/2 -translate-y-1/2 text-white/92 text-xs">E</div>
          </div>
          ...
          {error && (
            <p className="text-white/92 text-sm mt-2">{error}</p>
          )}
          ...
          <p className="text-white/88 text-xs mt-6 text-center max-w-xs">
