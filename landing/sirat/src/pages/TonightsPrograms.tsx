  ...
  return (
    <div className="min-h-screen bg-charcoal pb-20">
      <div className="px-5 pt-12">
        ...
        <p className="text-white text-sm mb-2">{today}</p>
        ...
        {allPrograms.length === 0 ? (
          <div className="text-center py-12">
            <Calendar size={40} className="text-white mx-auto mb-4" />
            <p className="text-white">No programs scheduled for tonight</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/5">
                  ...
                  <button
                    ...
                    className="text-xs text-white hover:text-gold flex items-center gap-1 transition-colors"
                  >
                    <Navigation size={12} />
                    View Center
                  </button>
