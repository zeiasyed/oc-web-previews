#!/usr/bin/env python3
"""Run NexaSource console + mock EDC behind nginx for production hosting."""
...
def _spawn(name: str, cmd: list[str], **env_extra: str) -> subprocess.Popen:
    ...
    env.setdefault("CONSOLE_PORT", "5050")
    env.setdefault("RAVE_PORT", "5051")
...
def main() -> int:
    ...
    nginx_out = Path("/tmp/nexasource-nginx.conf")
